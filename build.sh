...
SOURCES="src/main.c src/platform/generated/xdg-shell-protocol.c src/platform/linux_wayland.c src/platform/linux_portal.c src/platform/capture_pipewire.c src/codec/codec_ffmpeg.c src/codec/codec_ffmpeg_decode.c src/net/network_udp.c src/ui/render_gl.c src/ui/ui_simple.c"
